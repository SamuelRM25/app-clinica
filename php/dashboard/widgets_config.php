...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_widgets') {
        ...
        try {
            $stmt->execute([$hospital_id, $meta, $meta]);
        } catch (\Exception $e) {
        }
                ...
                <div class="row">
                    <div class="col-lg-9 mx-auto">
                        ...
                        <div style="margin-bottom: 2rem;">
                            <h3
                                style="font-size: 1rem; font-weight: 700; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 1rem;">
                                        ...
                                        <div class="widget-config-card animate-in">
                                            <div class="widget-info">
                                                <div class="widget-icon-box"
                                                    style="color: var(--color-<?php echo $data['color']; ?>); background: rgba(var(--color-<?php echo $data['color']; ?>-rgb,0,0,0), 0.1);">
                        ...
                        <div
                            style="background: var(--color-card); border: 1px solid var(--color-border); border-radius: var(--radius-xl); padding: 1.75rem; margin-bottom: 1.5rem;">
                            <h3
                                style="font-size: 1rem; font-weight: 700; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 1.5rem;">
                                <i class="bi bi-sliders me-2"></i>Límites y Comportamiento
                            </h3>
                            <div class="row g-4">
                                <div class="col-md-4">
                                    <label
                                        style="font-size: 0.8rem; font-weight: 700; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.4px; display: block; margin-bottom: 0.5rem;">Registros
                                        por Widget</label>
                                    <select name="display_limit"
                                        style="width:100%; padding: 0.6rem 0.875rem; border: 1.5px solid var(--color-border); border-radius: var(--radius-md); background: var(--color-surface); color: var(--color-text); font-size: 0.875rem;">
                                    ...
                                    <small style="color: var(--color-text-secondary); font-size: 0.75rem;">Máximo de
                                        filas por widget de lista.</small>
                                </div>
                                <div class="col-md-4">
                                    <label
                                        style="font-size: 0.8rem; font-weight: 700; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.4px; display: block; margin-bottom: 0.5rem;">Auto-Actualización</label>
                                    <select name="refresh_mins"
                                        style="width:100%; padding: 0.6rem 0.875rem; border: 1.5px solid var(--color-border); border-radius: var(--radius-md); background: var(--color-surface); color: var(--color-text); font-size: 0.875rem;">
                                    ...
                                    <small style="color: var(--color-text-secondary); font-size: 0.75rem;">Intervalo de
                                        refresco automático.</small>
                                </div>
                                <div class="col-md-4">
                                    <label
                                        style="font-size: 0.8rem; font-weight: 700; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.4px; display: block; margin-bottom: 0.5rem;">Umbral
                                        de Alerta de Stock</label>
                                    ...
                                    <small style="color: var(--color-text-secondary); font-size: 0.75rem;">Punto donde
                                        se activa la alerta de stock bajo.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            style="background: var(--color-card); border: 1px solid var(--color-border); border-radius: var(--radius-xl); padding: 1.75rem; margin-bottom: 2rem;">
                            <h3
                                style="font-size: 1rem; font-weight: 700; color: var(--color-text-secondary); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 1.5rem;">
                            ...
                            <div class="widget-config-card" style="margin-bottom: 0;">
                                <div class="widget-info">
                                    ...
                                    <div class="widget-text">
                                        <h4>Modo Compacto</h4>
                                        <p>Reduce el espaciado de los widgets para mostrar más información en pantalla.
                                        </p>
                                    </div>
                                </div>
                                <div class="widget-control">
