...
<head>
    ...
    :root {
        ...
        /* Ancho Sidebar */
        --sidebar-width: 280px;
        --sidebar-collapsed-width: 100px; /* Asegurado para evitar overcrowding */
    }
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="patient-info-card animate-in delay-1">
                <div class="patient-header">
                    ...
                    <div class="patient-details">
                        <h2 class="patient-name"><?php echo htmlspecialchars($patient['nombre'] . ' ' . $patient['apellido']); ?></h2>
                    ...
                    <div class="action-buttons">
                        ...
                        <a href="../hospitalization/ingresar_paciente.php?id_paciente=<?php echo $patient_id; ?>" class="btn-icon" title="Ingresar paciente" style="background-color: var(--color-success); color: white;">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo $patient['ultima_consulta'] ? date('d/m/Y', strtotime($patient['ultima_consulta'])) : 'N/A'; ?></span>
                    </div>
                </div>
            </div>
            ...
            <section class="appointments-section animate-in delay-3">
                <div class="section-header">
                    ...
                    <button type="button" class="action-btn" data-bs-toggle="modal" data-bs-target="#newMedicalRecordModal">
                                    ...
                                    <div id="collapseRecord<?php echo $record['id_historial']; ?>" 
                                        ...
                                        <div class="consultation-content">
                                            ...
                                            <div class="section-box mt-4" style="border-left-color: var(--color-primary);">
                                                ...
                                                <div class="section-content" style="font-family: 'Courier New', monospace; white-space: pre-wrap;">
                                                    <?php 
    ...
    <div class="modal fade" id="newMedicalRecordModal" tabindex="-1" aria-labelledby="newMedicalRecordModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content" style="background: var(--color-card); border: 1px solid var(--color-border); border-radius: var(--radius-lg); overflow: hidden;">
                <div class="modal-header" style="border-bottom: 1px solid var(--color-border); padding: var(--space-lg);">
                    <h5 class="modal-title" id="newMedicalRecordModalLabel" style="font-weight: 600; display: flex; align-items: center; gap: var(--space-sm);">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea id="examen_fisico" name="examen_fisico" class="form-control" rows="3" placeholder="Hallazgos del examen físico..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <textarea id="antecedentes_personales" name="antecedentes_personales" class="form-control" rows="2" placeholder="Alergias, cirugías, enfermedades previas..."></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <textarea id="examenes_realizados" name="examenes_realizados" class="form-control" rows="2" placeholder="Laboratorios, RX, ultrasonidos..."></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    <label for="resultados_examenes" class="form-label fw-semibold">Resultados Importantes</label>
                                    <textarea id="resultados_examenes" name="resultados_examenes" class="form-control" rows="2" placeholder="Valores críticos o hallazgos relevantes..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="hidden" name="especialidad_medico" value="<?php echo htmlspecialchars($user_specialty); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    
                    <div class="modal-footer" style="border-top: 1px solid var(--color-border); padding: var(--space-lg);">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" style="border-radius: var(--radius-md);">Cancelar</button>
