<?php
// report_insumos_mensual.php
// DEPRECATED — Este archivo no está enlazado desde la UI. Se conserva como
// referencia para la implementación futura del "Reporte Mensual de Insumos".
// Para activar:
//   1. Cambiar el form action del modal #insumosMensualModal de "GET" a este archivo
//   2. Reemplazar el WHERE para filtrar por mes: WHERE DATE_FORMAT(i.fecha, '%Y-%m') = ?
//   3. Quitar este comentario
session_start();
