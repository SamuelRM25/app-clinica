...
<head>
    ...
    <style>
        ...
        body { font-family: 'Inter', system-ui, sans-serif; background: var(--surface); color: var(--text); }

        .sub-header { background: linear-gradient(135deg, #0d6efd, #0099ff); color: white; padding: 2rem; border-radius: 1rem; margin-bottom: 2rem; }
        .sub-header h2 { font-weight: 700; margin: 0; }
        .sub-header p  { margin: 0; opacity: 0.85; }

        .status-chip { display: inline-flex; align-items: center; gap: .4rem; padding: .35rem .85rem; border-radius: 999px; font-weight: 600; font-size: .8rem; }
        .chip-activo    { background: #d1fae5; color: #065f46; }
        .chip-inactivo  { background: #fee2e2; color: #991b1b; }
        .chip-vencido   { background: #fef3c7; color: #92400e; }
        .chip-prueba    { background: #e0e7ff; color: #3730a3; }
        ...
        .module-card:hover    { border-color: var(--primary); box-shadow: 0 4px 16px rgba(13,110,253,.12); transform: translateY(-2px); }
        .module-card.selected { border-color: var(--primary); background: #eff6ff; }
        .module-card.active-now { border-color: var(--success); background: #f0fdf4; }
        .module-card.core-module { opacity: .7; cursor: not-allowed; border-color: var(--success); background: #f0fdf4; }

        .module-icon { width: 44px; height: 44px; border-radius: .625rem; display: flex; align-items: center; justify-content: center; font-size: 1.4rem; background: #e0e7ff; color: var(--primary); margin-bottom: .75rem; }
        .module-card.active-now .module-icon, .module-card.core-module .module-icon { background: #dcfce7; color: var(--success); }
        .module-card.selected .module-icon { background: var(--primary); color: white; }
        .module-name { font-weight: 600; font-size: .9rem; margin-bottom: .2rem; }
        .module-desc { font-size: .78rem; color: var(--text-muted); line-height: 1.4; }
        .module-price { font-size: .8rem; font-weight: 700; color: var(--primary); margin-top: .5rem; }
        .module-check { position: absolute; top: .75rem; right: .75rem; width: 20px; height: 20px; border-radius: 50%; border: 2px solid var(--border); background: white; display: flex; align-items: center; justify-content: center; }
        .module-card.selected .module-check, .module-card.active-now .module-check, .module-card.core-module .module-check { border-color: var(--success); background: var(--success); }
        .module-card.selected .module-check { border-color: var(--primary); background: var(--primary); }
        .module-check::after { content: '✓'; color: white; font-size: .7rem; font-weight: 700; display: none; }
        .module-card.selected .module-check::after,
        .module-card.active-now .module-check::after,
        .module-card.core-module .module-check::after { display: block; }

        .total-bar { background: #eff6ff; border: 1px solid #bfdbfe; border-radius: .75rem; padding: 1rem 1.5rem; display: flex; align-items: center; justify-content: space-between; }
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius:1rem;">
                <div class="card-body p-4">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr><td class="text-muted">Tipo</td><td class="fw-bold"><?php echo $h['tipo_suscripcion'] ?? '—'; ?></td></tr>
                        <tr><td class="text-muted">Estado</td>
                            <td><span class="status-chip <?php echo $chip_class; ?>"><?php echo $h['estado_suscripcion'] ?? '—'; ?></span></td>
                        </tr>
                        <tr><td class="text-muted">Vencimiento</td>
                    ...
                    <ul class="list-unstyled small text-muted mb-0">
                        <li class="mb-1"><i class="bi bi-bank me-1"></i>Transferencia Bancaria (BI, Banrural, G&T)</li>
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <div class="btn-group btn-group-sm" id="billingToggle" role="group">
                            ...
                            <label class="btn btn-outline-primary" for="bilAnual">Anual <span class="badge bg-warning text-dark ms-1">-15%</span></label>
                    ...
                    <div class="row g-2" id="moduleGrid">
                        ...
                        ?>
                        <div class="col-sm-6">
                            <div class="module-card <?php echo $class; ?>"
                                 ...
                                 <?php if ($is_core) echo 'onclick="return false;"'; ?>>
                    ...
                    <div class="total-bar mt-3">
                        ...
                        <div class="d-flex gap-2">
                            <button class="btn btn-outline-secondary btn-sm" onclick="resetSelection()">Restablecer</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:1rem; border:0;">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold"><i class="bi bi-send-check me-2 text-primary"></i>Confirmar Solicitud</h5>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <textarea id="reqMensaje" class="form-control" rows="2" placeholder="Cualquier consulta o aclaración..."></textarea>
                </div>
            </div>
