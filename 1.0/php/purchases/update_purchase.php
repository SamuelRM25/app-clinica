...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_compras'])) {
    try {
        ...
        $stmt = $conn->prepare("UPDATE compras SET nombre_compra = ?, presentacion_compra = ?, molecula_compra = ?, casa_compra = ?, cantidad_compra = ?, precio_unidad = ?, fecha_compra = ?, abono_compra = ?, total_compra = ?, tipo_pago = ?, estado_compra = ? WHERE id_compras = ?");
